...
/* harmony default export */ var paint_editor = (async _ref => {
  ...
  const getColor = element => {
    ...
    return Object(tinycolor_min["default"])(color).toHex8();
  };
  ...
  const convertToGeneralColor = hex => {
    let h = Object(tinycolor_min["default"])(hex).toHsv();
    h.s = 1;
    h.v = 1;
    return Object(tinycolor_min["default"])(h).toHex();
  };
  ...
  while (true) {
    ...
    function updateColor() {
      rateLimiter.limit(() => {
        ...
        let chsv = Object(tinycolor_min["default"])(c).toHsv();
    ...
    function updateHandle(e, keyPressed, originalPos) {
      ...
      if ((!addon.tab.redux.state.scratchPaint.fillMode.gradientType || addon.tab.redux.state.scratchPaint.fillMode.gradientType === "SOLID") && el) {
        let c = Object(tinycolor_min["default"])({
          h: origHue,
          s: cx / 150,
          v: 1 - cy / 150
        }).toHex();
    ...
    function updateFinal(e, keyPressed, originalPos) {
      rateLimiter.limit(() => {
        ...
        let color = Object(tinycolor_min["default"])(getColor(element)).toHsv();
        let s = ox / 150;
        let v = 1 - oy / 150;
        let newColor = Object(tinycolor_min["default"])({
          h: color.h,
          s: s,
          v: v,
          a: color.a
    ...
    if (defaultColor) {
      let defaultHexColor = Object(tinycolor_min["default"])(defaultColor).toHsv();
    ...
    saColorPicker.addEventListener("pointerdown", e => {
      ...
      if (el) origHue = Object(tinycolor_min["default"])(el.style.background).toHsv().h;
      updateHandle(e);
...
var style = __webpack_require__(2133);
