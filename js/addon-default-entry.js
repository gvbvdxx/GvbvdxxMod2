...
exports = module.exports = __webpack_require__(9)(false);
// imports
exports.i(__webpack_require__(2054), "");
...
var style = __webpack_require__(2131);
...
/* harmony default export */ var userscript = (async function (_ref) {
  ...
  class FindBar {
    constructor() {
      this.utils = new Utils["default"](addon);
      this.prevValue = "";
      ...
      for (const target of targets) {
        ...
        for (const id of Object.keys(blocks._blocks)) {
          ...
          if (block.opcode === "event_whenbroadcastreceived" && block.fields.BROADCAST_OPTION.value === name) {
            uses.push(new BlockInstance["default"](target, block));
...
var userstyle = __webpack_require__(2102);
...
/* harmony default export */ var code_editor = (async _ref => {
  ...
  // 250-ms rate limit
  const rateLimiter = new rate_limiter["default"](250);
  const getColor = element => {
    ...
    return Object(tinycolor_min["default"])("hsv(".concat(h, ", ").concat(s, ", ").concat(v || 0, ")")).toHexString();
  };
  const setColor = (hex, element) => {
    hex = Object(normalize_color["normalizeHex"])(hex);
  ...
  const addColorPicker = () => {
    ...
    saColorPickerText.addEventListener("change", () => {
      ...
      if (!Object(normalize_color["getHexRegex"])().test(value)) return;
      setColor(saColorPickerColor.value = Object(normalize_color["normalizeHex"])(value), element);
    });
...
var style = __webpack_require__(2130);
var style_default = /*#__PURE__*/__webpack_require__.n(style);
...
var style = __webpack_require__(2155);
var style_default = /*#__PURE__*/__webpack_require__.n(style);
...
var userstyle = __webpack_require__(2103);
var userstyle_default = /*#__PURE__*/__webpack_require__.n(userstyle);
...
var editor_searchable_dropdowns_userscript = __webpack_require__(2104);
...
var style = __webpack_require__(2135);
var style_default = /*#__PURE__*/__webpack_require__.n(style);
...
var block_duplicate_module = __webpack_require__(2066);
...
/* harmony default export */ var userscript = (async function (_ref) {
  ...
  const update = () => {
    block_duplicate_module["setCherryPicking"](!addon.self.disabled, addon.settings.get("invertDrag"));
  };
  addon.self.addEventListener("disabled", update);
  addon.self.addEventListener("reenabled", update);
  addon.settings.addEventListener("change", update);
  update();
  block_duplicate_module["load"](addon);
});
...
/* harmony default export */ var userscript = (async function (_ref) {
  ...
  const update = () => {
    block_duplicate_module["setDuplication"](!addon.self.disabled);
  };
  addon.self.addEventListener("disabled", update);
  addon.self.addEventListener("reenabled", update);
  update();
...
var userstyle = __webpack_require__(2166);
var userstyle_default = /*#__PURE__*/__webpack_require__.n(userstyle);
