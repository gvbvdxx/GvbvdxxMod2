...
var isScratchDesktop = __webpack_require__(140);
...
if (Object(isScratchDesktop["isScratchDesktop"])()) tw_disable_cloud_variables_manifest_entry_manifest.unsupported = true;
...
/* harmony default export */ var addon_manifests = __webpack_exports__["default"] = ({
...
var addon_manifests = __webpack_require__(121);

// EXTERNAL MODULE: ./src/addons/generated/upstream-meta.json
var upstream_meta = __webpack_require__(199);
...
class settings_store_SettingsStore extends event_target["default"] {
  constructor() {
    super();
  ...
  createEmptyStore() {
    const result = {};
    for (const addonId of Object.keys(addon_manifests["default"])) {
      result[addonId] = {};
    }
    return result;
  }
  ...
  getAddonManifest(addonId) {
    if (addon_manifests["default"][addonId]) {
      return addon_manifests["default"][addonId];
    }
  ...
  resetAllAddons() {
    for (const addon of Object.keys(addon_manifests["default"])) {
  ...
  parseUrlParameter(parameter) {
    ...
    for (const id of Object.keys(addon_manifests["default"])) {
  ...
  export(_ref) {
    ...
    for (const [addonId, manifest] of Object.entries(addon_manifests["default"])) {
  ...
  import(data) {
    for (const [addonId, value] of Object.entries(data.addons)) {
      if (!addon_manifests["default"].hasOwnProperty(addonId)) {
        continue;
      }
      const {
        enabled,
...
/* harmony default export */ var settings_store_singleton = __webpack_exports__["default"] = (settingStore);
