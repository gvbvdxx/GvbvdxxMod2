...
/* harmony default export */ var theme3 = (async function (_ref) {
  ...
  const secondaryColor = category => {
    ...
    if (isColoredTextMode()) return Object(text_color_esm["alphaBlend"])(primaryColor(category), Object(text_color_esm["multiply"])(addon.settings.get(category.settingId), {
      a: 0.15
    }));
    if (textMode() === "black") return Object(text_color_esm["brighten"])(addon.settings.get(category.settingId), {
      r: 0.6,
      g: 0.6,
      b: 0.6
    });
    return Object(text_color_esm["multiply"])(addon.settings.get(category.settingId), {
      r: 0.9,
      g: 0.9,
      b: 0.9
    });
  ...
  const tertiaryColor = category => {
    ...
    if (textMode() === "black") return Object(text_color_esm["multiply"])(addon.settings.get(category.settingId), {
      r: 0.65,
      g: 0.65,
      b: 0.65
    });
  ...
  const fieldBackground = category => {
    ...
    if (category instanceof Blockly.Block || category instanceof Blockly.Field) {
      ...
      if (isColoredTextMode() || textMode() === "black") {
        ...
        if (isColoredTextMode()) return Object(text_color_esm["alphaBlend"])(primary, Object(text_color_esm["multiply"])(block.getColourTertiary(), {
          a: 0.25
        }));else return Object(text_color_esm["brighten"])(primary, {
          r: 0.4,
          g: 0.4,
          b: 0.4
        });
    ...
    if (textMode() === "black") return Object(text_color_esm["brighten"])(primaryColor(category), {
      r: 0.4,
      g: 0.4,
      b: 0.4
    });
  ...
  Blockly.FieldDropdown.prototype.init = function () {
    ...
    if (textColor(this) !== "#ffffff") this.arrow_.style.filter = Object(text_color_esm["recolorFilter"])(textColor(this));
  };
  ...
  Blockly.FieldDropdown.prototype.showEditor_ = function () {
    ...
    Blockly.DropDownDiv.DIV_.style.backgroundColor = Object(text_color_esm["removeAlpha"])(primaryColor);
    if (isColoredTextMode()) {
...
var editor_theme3_theme3 = __webpack_require__(2137);
...
var black_text = __webpack_require__(2138);
...
var color_on_white = __webpack_require__(2139);
...
var color_on_black = __webpack_require__(2140);
