...
class gamepad {
            ...
            blocks: [
                {
                    ...
                    text: 'Get [player] gamepad stick axis X',
                    arguments: {
						player: {
                ...
                },
                {
					...
					name: 'Gamepad Y',
                    blockType: BlockType.REPORTER,
                    text: 'Get [player] gamepad stick axis Y',
                    arguments: {
						player: {
							acceptReporters: false,
							menu: 'gamepadnum'
				...
				{
                    opcode: 'getgamepad2ndX',
					name: 'Gamepad X',
                    blockType: BlockType.REPORTER,
                    text: 'Get [player] gamepad second stick axis X',
                    arguments: {
						player: {
							acceptReporters: false,
							menu: 'gamepadnum'
                ...
                {
                    opcode: 'getgamepad2ndY',
					name: 'Gamepad Y',
                    blockType: BlockType.REPORTER,
                    text: 'Get [player] gamepad second stick axis Y',
                    arguments: {
						player: {
							acceptReporters: false,
							menu: 'gamepadnum'
	...
	getgamepad2ndX (args) {
		var num = 0;
		try{num = (navigator.getGamepads()[Number(args.player)-1].axes[2]*10);}catch(e){}
		return num;
	}
	getgamepad2ndY (args) {
		var num = 0;
		try{num = (navigator.getGamepads()[Number(args.player)-1].axes[3]*-10);}catch(e){}
		return num;
	}
